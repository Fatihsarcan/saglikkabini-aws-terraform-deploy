...
<div style="max-width:580px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,.1);">
    <div style="background:#0d6efd;padding:30px;text-align:center;">
        <h1 style="color:#fff;margin:0;font-size:24px;">✅ Randevunuz Onaylandı</h1>
    </div>
    <div style="padding:30px;">
        ...
        <table style="width:100%;border-collapse:collapse;margin:20px 0;">
            ...
            <tr>
                <td style="padding:12px;border:1px solid #dee2e6;font-weight:bold;">Uzmanlık</td>
                <td style="padding:12px;border:1px solid #dee2e6;">{{ $appointment->doctor->specialty }}</td>
            </tr>
            <tr style="background:#f8f9fa;">
        ...
        <p><strong>Notunuz:</strong> {{ $appointment->notes }}</p>
        @endif

        <p style="color:#6c757d;font-size:14px;">Randevunuzu iptal etmek için uygulamamıza giriş yapabilirsiniz.</p>
    </div>
