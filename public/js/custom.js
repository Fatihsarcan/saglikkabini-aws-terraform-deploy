...
$(function () {
    ...
    margin: 30,              // item arası boşluk
    mouseDrag: true,         // fare ile sürükleme
    autoplay: true,          // otomatik kaydırma
    autoplayTimeout: 3000,   // 3 saniye
    autoplayHoverPause: true,// mouse üstünde durdur
    dots: false,             // alt noktalar kapalı
    nav: true,               // ileri/geri buton
    navText: [
